...
class EXISTModel(pl.LightningModule):
    ...
    def _step(self, batch, batch_idx):
        ...
        id_features = batch.get("id_features", None)
        et_features = batch.get("et_features", None)
        hr_features = batch.get("hr_features", None)
        eeg_features = batch.get("eeg_features", None)
